 ...
 *   1. Swipe the drag handle downward past SWIPE_DISMISS_THRESHOLD px
 *   2. Tap the semi-transparent backdrop
 *   3. Press the ✕ button inside the child panel
 *
 ...
 * @param children - The detail panel content to render inside the sheet.
 * @example
 *   <MobileBottomSheet onClose={closePanel}>
 *     <DetailPanel ... />
 *   </MobileBottomSheet>
 */
function MobileBottomSheet({ onClose, children }: { onClose: () => void; children: ReactNode }) {
